...
const Footer = () => {
  return (
    ...
    >
      ...
      >
        <div>
          <motion.img
            ...
            src={assets.logo}
            alt="logo"
            className=" h-8 w-10 md:w-12 md:h-9"
          />
          <motion.p
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
          ...
          >
            Premium Swift Drive Service with a wide selection of luxury and
            everyday vehicles for all your driving needs. Experience the best in
            car rental with us.
          </motion.p>
          <motion.div
            initial={{ opacity: 0 }}
      ...
      >
        <p>© {new Date().getFullYear()} Swift Drive. All rights reserved.</p>
